...
const ProjectCard = ({ index, name, description, tags, image, source_code_link, web_link }) => {
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <div className="bg-tertiary p-5 rounded-2xl md:w-[360px] w-[300px] h-full">
        ...
        <div className="mt-4 flex justify-start items-center">
          <a
            href={`${web_link}`}
            target="_blank"
            className="text-[14px] cursor-pointer no-underline text-secondary hover:text-white"
          >
            View Website &rarr;
          </a>
        </div>
...
const Works = () => {
  return (
    <>
      ...
      <div className="mt-20 flex md:flex-wrap flex-1 flex-nowrap gap-7">
